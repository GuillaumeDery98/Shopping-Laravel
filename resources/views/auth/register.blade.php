            ...
            <div class="card">
                <form method="POST" action="{{ route('register') }}">
                    <div class="card-content">
                        ...
                        <x-input name="password" type="password" icon="lock" label="Mot de passe" required="true">
                        </x-input>
                        <div class="row">
                        ...
                        <div class="row col s12">
                            <label>
                                ...
                                <span>J'accepte les termes et conditions de .</span>
                            </label>
                        </div>

                        <p>
                            <button class="btn waves-effect waves-light disabled" style="width: 100%" type="submit"
                                name="action">
                                Enregistrer
                            </button>
                        </p>
